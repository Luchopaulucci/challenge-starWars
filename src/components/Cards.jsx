...
const Cards = () => {
  return (
    ...
    <CardHeader className="absolute z-10 top-1 flex-col items-start">
      <p className="text-tiny text-white/60 uppercase font-bold">HUMAN</p>
      <h4 className="text-white/90 font-medium text-xl">Luke Skywalker</h4>
    </CardHeader>
    <Image
      removeWrapper
    ...
    <CardFooter className="absolute bg-black/40 bottom-0 z-10 border-t-1 border-default-900 dark:border-default-100">
      <Button radius="full" size="sm">Get more info</Button>
    </CardFooter>
  </Card>
  )
}
